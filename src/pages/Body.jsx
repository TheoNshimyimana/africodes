...
function Body() {
  ...
  return (
    <>
      ...
      >
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="mt-4 leading-10 text-slate-600 text-base md:text-lg">
            <strong>Africode Consultancy</strong> specializes in ICT
            ...
            expertise ensure efficient and professional services, aligning with
      ...
      {/* Services Section */}
      <section id="services" className="py-12 px-4 md:px-8 bg-gray-50">
